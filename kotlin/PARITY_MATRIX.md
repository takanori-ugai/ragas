...
| Tokenizers | Done | Public tokenizer parity surface is exposed (`BaseTokenizer`, `TiktokenWrapper`, `HuggingFaceTokenizer`, `getDefaultTokenizer`, `getTokenizer`, `DEFAULT_TOKENIZER`) with JTokkit-backed default (`o200k_base`) |
