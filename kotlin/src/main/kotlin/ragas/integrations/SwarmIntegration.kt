...
/**
 * Input record schema for Swarm integration adapters.
 *
...
/**
 * Helper functions for evaluating Swarm records with ragas metrics.
 */
object SwarmIntegration {
    /**
     * Converts integration records into an evaluation dataset.
     *
     * @param records Integration records to process.
     */
    fun toDataset(records: List<SwarmRecord>): EvaluationDataset<SingleTurnSample> =
        EvaluationDataset(
            records.map { record ->
                SingleTurnSample(
    ...
    fun evaluateRecords(
        ...
        runName: String = "ragas-swarm-evaluation",
